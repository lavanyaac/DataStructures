...
const Range = function(start, end, step) {
	...
	this.step = (step !== undefined)? step: (this.start < this.end)? -1: 1;
};
...
const evenNumbers = new Range(2,8,2); // A range with the even numbers 2, 4, 6, and 8.
evenNumbers.each(function(val){
 console.log(val+"!");
});
