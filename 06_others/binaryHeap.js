...
BinaryHeap.prototype._swap = function(index1, index2){
...
BinaryHeap.prototype.removeRoot = function () {
	...
	let tempRootIndex = 0;
	let getLesserChildIndex = this._getSmallestChild(tempRootIndex);
	while(getLesserChildIndex && this._compare(this._heap[getLesserChildIndex], this._heap[tempRootIndex])){
		this._swap(getLesserChildIndex, tempRootIndex);
		tempRootIndex = getLesserChildIndex;
		getLesserChildIndex = this._getSmallestChild(tempRootIndex);
	}
	return originalroot;
};
